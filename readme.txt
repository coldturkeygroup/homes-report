...
Installing "Homes Report" can be done either by searching for "Homes Report" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
